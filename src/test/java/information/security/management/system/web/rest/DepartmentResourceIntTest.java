...
import information.security.management.system.domain.Department;
import information.security.management.system.repository.DepartmentRepository;
...
public class DepartmentResourceIntTest {
    ...
    public void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getRoom()).isEqualTo(DEFAULT_ROOM);
    }
    ...
    public void updateDepartment() throws Exception {
        ...
        assertThat(testDepartment.getRoom()).isEqualTo(UPDATED_ROOM);
    }
